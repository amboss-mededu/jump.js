...
var jumper = function jumper() {
  ...
  var container = void 0; // wrapper element                        (node)
  ...
  // Higher order function to handle scrolling
  // in both global viewport (window) or a custom
  // container
  function scrollTo(offset) {
    container && container.scrollTo ? window.scrollTo(0, offset) // Window object
    : container.scrollTop = offset; // Node container
  }
